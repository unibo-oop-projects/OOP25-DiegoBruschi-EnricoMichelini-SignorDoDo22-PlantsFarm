...
public class TileManager {
    ...
    public TileManager(ViewGamePanel gp) {
        this.gp = gp;
    ...
    public void loadMap(String filePath) {
        try {
            ...
            System.out.println(gp.maxScreenCol + " " + gp.maxScreenRow);
    ...
    public void drawTile(Graphics2D g2) {
        ...
        while (col < gp.maxScreenCol && row < gp.maxScreenRow) {
            ...
            g2.drawImage(tile[tileNum].image, x - gp.camera.x , y - gp.camera.y , gp.tileSize, gp.tileSize, null);
